...
const light = {
  ...
  styleGroups: {
    water: [
      { zIndex: 7, type: 'Line', strokeWidth: 4, stroke: '#E6E6E6' },
      { zIndex: 7, type: 'Polygon', fill: '#ffffff' },
    ],

    waterZ8: [
      { zIndex: 7, type: 'Line', strokeWidth: 9, stroke: '#E6E6E6' },
      { zIndex: 7, type: 'Polygon', fill: '#ffffff' },
    ],

    waterZ14: [
      { zIndex: 7, type: 'Line', strokeWidth: 6, stroke: '#E6E6E6' },
      { zIndex: 7, type: 'Polygon', fill: '#ffffff' },
    ],
